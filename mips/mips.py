import devicemanager, parsemanager, templater
import subprocess
import serial
...
def main():
    ...
    device_objects = devicemanager.import_devices(device_dictionaries)

    rendered_template = templater.render_template(device_objects, is_test)
